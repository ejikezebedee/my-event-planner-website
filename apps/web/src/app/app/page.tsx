    ...
    <div>
      ...
      {d.alerts.overdueExpenses > 0 && (
        <div className="mb-6 flex items-center gap-2 rounded-lg border border-destructive/40 bg-destructive/10 p-4 text-sm">
          ...
          {d.alerts.overdueExpenses} expense{d.alerts.overdueExpenses > 1 ? "s are" : " is"} overdue
          for payment.
        </div>
      )}
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">{d.events.total}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <CardContent>
            <p className="text-2xl font-bold">
              <MoneyText minor={d.finances.actual} currency={current.currency} />
            </p>
            <p className="text-xs text-muted-foreground">
              of <MoneyText minor={d.finances.budget} currency={current.currency} /> budgeted
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">
              <MoneyText minor={d.finances.paid} currency={current.currency} />
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">{d.guests.total}</p>
          </CardContent>
        </Card>
      </div>
