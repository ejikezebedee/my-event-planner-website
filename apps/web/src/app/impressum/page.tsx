  ...
  return (
    <main className="container max-w-3xl py-16">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Legal notice pursuant to § 5 DDG (Germany)
      </p>
      <div className="mt-8 rounded-lg border border-amber-500/40 bg-amber-500/10 p-4 text-sm">
        This deployment must not be launched publicly until the operator replaces the fields below
        with verified legal details.
      </div>
      <section className="mt-8">
        ...
        <p className="mt-2 text-sm leading-6 text-muted-foreground">
          ...
          <br />
          [FULL SERVICEABLE STREET ADDRESS]
          <br />
      ...
      <section className="mt-8">
        ...
        <p className="mt-2 text-sm leading-6 text-muted-foreground">
          [INSERT LEGALLY REVIEWED STATEMENT ON WILLINGNESS OR OBLIGATION TO PARTICIPATE IN CONSUMER
          ARBITRATION.]
        </p>
      </section>
